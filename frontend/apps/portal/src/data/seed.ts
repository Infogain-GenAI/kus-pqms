...
export const ISSUES: Issue[] = [
  ...
  mk({
    ...
    model: 'EV9', modelYear: 2026, system: 'Electrical / HV', subSystem: 'Charge port actuator', component: 'Charge port actuator', symptom: 'Charge port fails to unlatch',
