...
export const ISSUES: Issue[] = [
  ...
  mk({
    id: 'HV-260101', title: 'Charge port door fails to unlatch on driver request', source: 'warranty', sources: ['warranty', 'fpqr'], status: 'open',
